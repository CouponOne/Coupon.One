...
//
// Detailed usage document and tutorial available on the go-conponone Wiki page:
// https://github.com/CouponOne/Coupon.One/wiki/Native-DApps:-Go-bindings-to-Ethereum-contracts
package bind
