...
var (
	...
	authorsFileHeader = "# This is the official list of go-conponone authors for copyright purposes.\n\n"
)

// this template generates the license comment.
// its input is an info structure.
var licenseT = template.Must(template.New("").Parse(`
// Copyright {{.Year}} The go-conponone Authors
...
func (i info) Whole(startOfSentence bool) string {
	...
	if startOfSentence {
		return "The go-conponone library"
	}
	return "the go-conponone library"
}
