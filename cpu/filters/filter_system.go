...
// Package filters implements an conponone filtering system for block,
...
type subscription struct {
	...
	typ       Type
	created   time.Time
	logsCrit  conponone.FilterQuery
	logs      chan []*types.Log
...
func (es *EventSystem) SubscribeLogs(crit conponone.FilterQuery, logs chan []*types.Log) (*Subscription, error) {
...
func (es *EventSystem) subscribeMinedPendingLogs(crit conponone.FilterQuery, logs chan []*types.Log) *Subscription {
	sub := &subscription{
		id:        rpc.NewID(),
...
func (es *EventSystem) subscribeLogs(crit conponone.FilterQuery, logs chan []*types.Log) *Subscription {
	sub := &subscription{
		id:        rpc.NewID(),
...
func (es *EventSystem) subscribePendingLogs(crit conponone.FilterQuery, logs chan []*types.Log) *Subscription {
	sub := &subscription{
		id:        rpc.NewID(),
